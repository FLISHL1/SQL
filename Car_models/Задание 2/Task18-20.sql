...
SELECT CONCAT(emp.lastName, ' ', emp.firstName) as employ, CONCAT(rep.lastName, ' ', rep.firstName) as reportTo FROM employees as emp LEFT JOIN employees as rep ON emp.reportsTo=rep.employeeNumber;
